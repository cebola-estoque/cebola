...
module.exports = function (cebola, options) {
   ...
   */
  inventoryCtrl.shipmentSummary = function (shipment, query, filter, sort) {
   ...
   * @return {Bluebird -> Summary}  
   */
  inventoryCtrl.productSummary = function (product, query, filter, sort) {
    ...
    return inventoryCtrl.summary(query, filter, sort).then((summary) => {
