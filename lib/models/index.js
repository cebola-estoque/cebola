module.exports = function (connection, cebola, options) {
   ...
   */
  var ProductAllocation = require('./product-allocation')(ProductRecord, connection, cebola, options);
  var ProductOperation  = require('./product-operation')(ProductRecord, connection, cebola, options);
