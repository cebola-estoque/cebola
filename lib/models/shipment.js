...
//     let alloc = allocations.find((alloc) => {
//       let isSameProductModel  = alloc.productModel._id === op.productModel._id;
//       let isSameProductExpiry = moment(alloc.productExpiry).isSame(op.productExpiry);
//       let isSameQuantityUnit  = alloc.quantity.unit === op.quantity.unit;
...
//       let effectivated = alloc.operations.reduce((res, op) => {
//         return res + op.quantity.value;
//       }, 0);

//       let remainingValue = alloc.quantity.value - effectivated;
